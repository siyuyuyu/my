...
from mover.active.models.GeomNP import utils
from  mover.active.models.GeomNP.layers import GraphConvolution
...
if __name__ == "__main__":
    ...
    input_data_paths = os.listdir(
        os.path.join(current_directory, "input_graph_datasets"))  # this is the list of all datasets we have

    #input_data_paths = os.listdir("./input_graph_datasets") # this is the list of all datasets we have
    path = os.path.join(current_directory, "input_graph_datasets/tox21_ahr.pkl")
    print(path)
    ...
    train, test = utils.get_data(path=path, filter_graphs_min=50)
